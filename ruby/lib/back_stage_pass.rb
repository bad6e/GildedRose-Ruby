...
class BackStagePass
  ...
  def check_sell_in_days_remaining
    if sell_in > 10
      check_previous_quality_number_against_quality_limit(1)
    elsif sell_in > 5 && sell_in <= 10
      check_previous_quality_number_against_quality_limit(2)
    elsif sell_in > 0 && sell_in <= 5
      check_previous_quality_number_against_quality_limit(3)
    else
  ...
  def check_previous_quality_number_against_quality_limit(factor)
